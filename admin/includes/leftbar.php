	<nav class="ts-sidebar" style="background-color:gray">
		<ul class="ts-sidebar-menu">
			...
			<li><a href="departments.php"><i class="fa fa-files-o"></i> Manage Departments</a>
			...
			<li><a href="newservices.php"><i class="fa fa-laptop"></i> New Service Requests</a>

			</li>
			<li><a href="checkedservices.php"><i class="fa fa-laptop"></i> Checked Requests</a>
