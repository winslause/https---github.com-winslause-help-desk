...
try {
  if (isset($_POST['emailid']) && isset($_POST['password'])) {
    ...
    $sql = "SELECT * FROM tblstaff WHERE email=:emailn and password=:password";
...
<body style="background-color: white;">
  ...
  <div align="center">
    ...
    <label class="form-check-label" for="exampleCheck1">Check me out</label> -->
      ...
      <small id="emailHelp" class="form-text text-muted">Dont have an account, <a href="staffregister.php">CLICK HERE</a> to register</small><br />
